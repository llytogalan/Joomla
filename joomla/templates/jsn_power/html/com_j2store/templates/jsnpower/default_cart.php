...
?>
	...
	<?php if($show): ?>
		...
		<?php echo J2Store::product()->displayQuantity('com_j2store.productlist.bootstrap3', $this->product, $this->params, array( 'class'=>'input-mini form-control ' ) ); ?>
			...
			<!-- overide input to button -->
			<button type="submit" data-cart-action-always="<?php echo JText::_('J2STORE_ADDING_TO_CART'); ?>"
					data-cart-action-done="<?php echo $cart_text; ?>"
					data-cart-action-timeout="1000"
				   type="submit"
				   class="j2store-cart-button <?php echo $this->params->get('addtocart_button_class', 'btn btn-default');?>"
			>
