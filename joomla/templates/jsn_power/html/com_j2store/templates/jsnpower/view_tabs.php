			...
			<div class="tab-content-detail">
				...
				<div class="tab-content">
					...
					<div itemprop="description" class="tab-pane fade in active" id="description">
						<h2><?php echo JText::_('J2STORE_PRODUCT_DESCRIPTION')?></h2><?php echo $this->loadTemplate('ldesc'); ?>
					</div>
					<?php endif;?>

					<?php if($this->params->get('item_show_product_specification')):?>
						<div class="tab-pane fade in <?php echo isset($set_specification_active) && $set_specification_active ? 'active' : '';?>" id="specs">
							<h2><?php echo JText::_('J2STORE_PRODUCT_SPECIFICATIONS')?></h2><?php echo $this->loadTemplate('specs'); ?>
						</div>
					<?php endif;?>
				</div>
			</div>
