...
$document->addCustomTag('<meta property="og:description" content="'. JHtml::_('string.truncate', htmlentities(strip_tags(current(explode("\n", trim(preg_replace('/{(.*?)}/i', '', $this->item->introtext)), 2))), ENT_QUOTES), 130, false, false ) .'" />');
