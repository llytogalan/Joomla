					...
					<div class="col-sm-<?php echo round((12 / $total_cols));?>">
						<div itemprop="itemListElement" itemscope="" itemtype="http://schema.org/Product" class="j2store product-<?php echo $product->j2store_product_id; ?> j2store-module-product">
							...
							<?php if($product->pricing->base_price != $product->pricing->price) : ?>
								<div class="sale-tag">
									<?php echo JText::_('J2STORE_SALE_TAG_FOUND'); ?>
								</div>
							<?php endif;?>
							<!-- product title -->
						...
						<div class="product-cart-section col-sm-12 ">
							...
							<div class="product-cart-left-block <?php echo $img_class; ?>" >
								...
								<?php elseif( $product->product_type=='configurable' || ($cart_type == 2 && count($product->options)) || $cart_type==3 ):?>
									...
									<a href="<?php echo $product->module_display_link; ?>" class="j2store-button-cart  <?php echo $params->get('choosebtn_class', 'btn btn-outline'); ?>"><i class="fa fa-eye"></i><?php echo JText::_('J2STORE_VIEW_PRODUCT_DETAILS'); ?></a>
