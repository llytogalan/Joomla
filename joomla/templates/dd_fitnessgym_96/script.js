...
jQuery(function($) {
    ...
    var activeLayoutType = $.cookie('layoutType') || 'grid',
        activeLayoutTypeSelector = $.cookie('layoutSelector') || '.separated-item-10.grid';
    ...
    if (typeof window.buildTypeSelector === 'function') {
        ...
        $(document).on('click', '.bd-products i[data-layout-name="bd-griditemgrid"]', function (e) {
            if (activeLayoutType !== 'grid') {
                var grid = $('.bd-grid-14');
                grid.find('.separated-item-10.grid').css('display', 'block');
                grid.find(activeLayoutTypeSelector).css('display', 'none');
                activeLayoutType = 'grid';
                activeLayoutTypeSelector = '.separated-item-10.grid';
        ...
        $(document).on('click', '.bd-products i[data-layout-name="bd-griditemlist"]', function (e) {
            if (activeLayoutType !== 'list') {
                var grid = $('.bd-grid-14');
                grid.find('.separated-item-11.list').css('display', 'block');
                grid.find(activeLayoutTypeSelector).css('display', 'none');
                activeLayoutType = 'list';
                activeLayoutTypeSelector = '.separated-item-11.list';
...
jQuery(function ($) {
    ...
    $('.bd-productsslider-1').each(function () {
        ...
        leftButton.find('.bd-carousel-7').click(function() {
            slider.carousel('prev');
            return false;
        }).attr('href', '#');

        rightButton.find('.bd-carousel-7').click(function() {
            slider.carousel('next');
            return false;
        }).attr('href', '#');
