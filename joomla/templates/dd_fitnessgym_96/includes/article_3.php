...
<div class=" bd-postimage-3 bd-no-margins">
    ...
    <?php if ($caption): ?>
    <div class=" bd-container-54 bd-tagstyles bd-bootstrap-btn bd-btn-warning ">
        <?php echo $caption; ?>
    </div>
    <?php endif; ?>
</div>
...
?>
<div class=" bd-postcontent-3 bd-tagstyles bd-bootstrap-btn bd-btn-warning bd-contentlayout-offset" <?php echo $attr; ?> itemprop="articleBody">
