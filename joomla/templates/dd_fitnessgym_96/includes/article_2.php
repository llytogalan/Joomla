...
<div class=" bd-postimage-1">
    ...
    <?php if ($caption): ?>
    <div class=" bd-container-50 bd-tagstyles bd-bootstrap-btn bd-btn-warning ">
        <?php echo $caption; ?>
    </div>
    <?php endif; ?>
</div>
...
?>
<div class=" bd-postcontent-2 bd-tagstyles bd-custom-blockquotes bd-bootstrap-btn bd-btn-warning bd-contentlayout-offset" <?php echo $attr; ?> itemprop="articleBody">
...
<a class="bd-postreadmore-2 btn   btn-warning " href="<?php echo $data['readmore-link'] ?>" >
