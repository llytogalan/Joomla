...
$megamenuClass = '';
$megamenuSubCatItemClass = 'bd-sub-item bd-mega-item  bd-menuitem-49';
...
ob_start();
?>
<div class="bd-menu-15  bd-mega-grid bd-grid-11">
...
ob_start();
?>
<div class="bd-menuitem-40 bd-sub-item bd-mega-item  bd-menuitem-48 separated-item-17">
    <div class="bd-griditem-17 bd-grid-item">
<?php
...
ob_start();
?>
<li class=" bd-menuitem-38 bd-toplevel-item {submenu_icon_only}">
<?php 
$menuStartItem = ob_get_clean();
ob_start();
?>

<ul class=" bd-menu-14 nav navbar-left nav-pills<?php echo $class_sfx;?>" <?php echo $tag_id; ?>>
<?php
$bHMenu = ob_get_clean();
$eHMenu = "</ul>";
?>
...
<?php $subMenuStartItem = ob_get_clean(); ?>
    ...
    if ($item->deeper) {
        ...
        ?>
        <div class="bd-menu-15-popup<?php echo $item->megaclass && $item->level == 2 ? ' bd-megamenu-popup' : ''; ?>">
