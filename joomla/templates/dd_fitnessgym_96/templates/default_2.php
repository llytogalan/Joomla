...
<body class=" bootstrap bd-body-2  bd-pagebackground-2352 bd-margins">
    <div data-affix
     data-offset=""
...
<div class="bd-contentlayout-2  bd-sheetstyles  bd-no-margins bd-margins" >
 ...
 <?php renderTemplateFromIncludes('sidebar_area_4'); ?>
		...
		<section class=" bd-section-12 bd-tagstyles bd-bootstrap-btn bd-btn-warning" id="section20" data-section-title="Gallery">
    <div class="bd-container-inner bd-margins clearfix">
        <?php
    renderTemplateFromIncludes('joomlaposition_51');
?>
    </div>
</section>
