...
<body class=" bootstrap bd-body-9  bd-pagebackground bd-margins">
    ...
    <div class="bd-container-inner">
        <a class="bd-imagelink-11 bd-no-margins  bd-own-margins "  href="index.php">
<img class=" bd-imagestyles" src="<?php echo JURI::base() . 'templates/' . JFactory::getApplication()->getTemplate(); ?>/images/404.jpg">
</a>
    </div>
</div></div>
