...
<div data-slider-id="product_slider" class=" bd-productsslider-1" data-elements-per-row="<?php echo $products_per_row; ?>">
    ...
    <div class=" bd-block bd-own-margins <?php echo $params->get('moduleclass_sfx'); ?>">
    ...
    <?php
        ...
        if (is_object($productItems->productImage->image))
            $imgHtml = $productItems->productImage->image->displayMediaThumb('class=" bd-imagestyles-53"', false);
        else
            $imgHtml = str_replace('<img', '<img class=" bd-imagestyles-53" ', $productItems->productImage->image);
    ?>
...
<div class=" bd-pricetext-1">
    ...
    <span class=" bd-container-35 bd-tagstyles bd-bootstrap-btn bd-btn-warning salesPrice">
...
<form method="post" class="product" action="<?php echo JRoute::_ ('index.php'); ?>">
    <?php
        ...
        $buttonDataAttrs = '';
        $classNames = ' bd-productbuy-1 btn   btn-warning';
    ?>
