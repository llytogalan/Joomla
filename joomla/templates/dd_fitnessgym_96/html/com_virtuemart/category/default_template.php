...
<div class=" bd-products"  >
    ...
    <div class=" bd-container-167 bd-tagstyles bd-bootstrap-btn bd-btn-warning">
 ...
 col-sm-6
 col-xs-4">
    <div class="bd-layoutcolumn-88 bd-column" ><div class="bd-vertical-align-wrapper"><div class=" bd-typeselector-1">
 ...
 col-sm-6
 col-xs-8">
    <div class="bd-layoutcolumn-89 bd-column" ><div class="bd-vertical-align-wrapper"><div class=" bd-productssorter-1">
    ...
    <div class="separated-item-10 col-md-3 col-sm-6 grid vm-product-item"<?php if ('grid' !== $activeLayoutName): ?> style="display: none;"<?php endif ?>>
    ...
    <?php
        ...
        if (is_object($productItems->productImage->image))
            $imgHtml = $productItems->productImage->image->displayMediaThumb('class=" bd-imagestyles-54"', false);
        else
            $imgHtml = str_replace('<img', '<img class=" bd-imagestyles-54" ', $productItems->productImage->image);
    ?>
...
<div class=" bd-productprice-4 product-prices">
    ...
    if ($productItems->productPrice->show_prices == '1') {
        ...
        ?>
        <a class="ask-a-question  btn   btn-warning" href="<?php echo $askquestion_url; ?>" rel="nofollow" >
...
<div class=" bd-pricetext-12 bd-no-margins">
    ...
    <span class=" bd-container-183 bd-tagstyles bd-bootstrap-btn bd-btn-warning basePrice">
...
<div class=" bd-pricetext-11">
    ...
    <span class=" bd-container-170 bd-tagstyles bd-bootstrap-btn bd-btn-warning salesPrice">
...
<form method="post" class="product" action="<?php echo JRoute::_ ('index.php'); ?>">
    <?php
        ...
        $buttonDataAttrs = '';
        $classNames = ' bd-productbuy-4 btn   btn-warning';
    ?>
...
<?php endif; ?>
    ...
    <div class="separated-item-11 col-md-12 list vm-product-item"<?php if ('list' !== $activeLayoutName): ?> style="display: none;"<?php endif ?>>
 ...
 col-md-3
 col-sm-6">
    <div class="bd-layoutcolumn-90 bd-column" ><div class="bd-vertical-align-wrapper"><?php if (isset($productItems->productImage)) : ?>
    <?php if ($productItems->productImage->imagesExists) : ?>
    <?php
        $offsetHeight = isset($productItems->productImage->offsetHeight) ? $productItems->productImage->offsetHeight : 0;
        $offsetWidth = isset($productItems->productImage->offsetWidth) ? $productItems->productImage->offsetWidth : 0;
...
<?php endif; ?></div></div>
 ...
 col-md-6">
    <div class="bd-layoutcolumn-93 bd-column" ><div class="bd-vertical-align-wrapper"><?php if (isset($productItems->productTitle)) : ?>
...
<?php endif; ?></div></div>
 ...
 col-md-3">
    <div class="bd-layoutcolumn-94 bd-column" ><div class="bd-vertical-align-wrapper"><?php if (isset($productItems->productPrice)) : ?>
...
<div class=" bd-pricetext-14">
    ...
    <span class=" bd-container-191 bd-tagstyles bd-bootstrap-btn bd-btn-warning basePrice">
        <?php echo $oldPriceObj['html']; ?>
    </span>
</div>
<?php endif; ?>
...
<div class=" bd-pricetext-13">
    ...
    <span class=" bd-container-184 bd-tagstyles bd-bootstrap-btn bd-btn-warning salesPrice">
        <?php echo $regularPriceObj['html']; ?>
    </span>
</div>
<?php endif; ?>
...
<form method="post" class="product" action="<?php echo JRoute::_ ('index.php'); ?>">
    <?php
        // todo output customfields
        $buttonDataAttrs = '';
        $classNames = ' bd-productbuy-5 btn   btn-warning';
    ?>
    <?php if (!VmConfig::get('use_as_catalog', 0)) : ?>
        <?php
            $quantity = 1;
