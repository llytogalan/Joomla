...
<div class=" bd-productoverview vm-product-item"  >
 ...
 col-sm-12
 col-xs-12">
    <div class="bd-layoutcolumn-84 bd-column" ><div class="bd-vertical-align-wrapper"><h2 class=" bd-productoverviewtitle-1">
    <?php echo $productItems->productTitle->name; ?>
</h2>
	
		<?php if (!empty($this->product->images)) : ?>
<?php $image = $this->product->images[0]; ?>
<div class=" bd-productimage-4 ">
                ...
                <?php endif ?>
                    ...
                    <a class=" bd-productimage-6"
                       ...
                       href="<?php echo JURI::root() . $image->file_url; ?>">
                        <img class=" bd-imagestyles" src="<?php echo $thumbUrl; ?>" />
                    </a>
...
<?php endif ?></div></div>
 ...
 col-sm-12
 col-xs-12">
    <div class="bd-layoutcolumn-85 bd-column" ><div class="bd-vertical-align-wrapper"><?php if (isset($productItems->productPrice)) : ?>
...
<div class=" bd-pricetext-10">
    ...
    <span class=" bd-container-90 bd-tagstyles bd-bootstrap-btn bd-btn-warning basePrice">
...
<div class=" bd-pricetext-9">
    ...
    <span class=" bd-container-89 bd-tagstyles bd-bootstrap-btn bd-btn-warning salesPrice">
...
<form method="post" class="product" action="<?php echo JRoute::_ ('index.php'); ?>">
    <?php
        ...
        $buttonDataAttrs = '';
        $classNames = ' bd-productbuy-3 bd-button-1';
    ?>
...
<div class=" bd-tabinformationcontrol-2 tabbable" data-responsive="true">
    ...
    <li class=" bd-menuitem-9 active">
        <a href="#tab1" data-toggle="tab"><span><?php echo JText::_ ('COM_VIRTUEMART_REVIEWS') ?></span></a>
    </li>
</ul></div>
    <div class=" bd-container-101 bd-tagstyles bd-bootstrap-btn bd-btn-warning tab-content">
    <div id="tab1" class="tab-pane active">
        <div class="std">
            <?php if ($this->allowRating || $this->showReview): ?>
                <?php echo $this->loadTemplate('reviews_' . $reviewTemplateId); ?>
            <?php endif; ?>
        </div>
    </div>
</div>
    ...
    <div class=" bd-container-43 bd-tagstyles bd-bootstrap-btn bd-btn-warning accordion-content"></div>
</div>
    </div>
</div>
