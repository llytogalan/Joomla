...
<div class=" bd-productreviews-1">
    <?php if ($this->showReview):	?>
        <div class=" bd-container-102 bd-tagstyles bd-bootstrap-btn bd-btn-warning">
 ...
 col-md-1">
    <div class="bd-layoutcolumn-86 bd-column" ><div class="bd-vertical-align-wrapper"><div class=" bd-reviewavatar-1">
 ...
 col-md-11">
    <div class="bd-layoutcolumn-87 bd-column" ><div class="bd-vertical-align-wrapper"><div class=" bd-reviewmetadata-1">
    ...
    <form method="post" action="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=' . $this->product->virtuemart_product_id . '&virtuemart_category_id=' . $this->product->virtuemart_category_id); ?>" name="reviewForm" id="reviewform">
            ...
            ?>
            <div class=" bd-container-114 bd-tagstyles bd-bootstrap-btn bd-btn-warning">
                <h4>
    ...
    <?php endfor; ?>
            ...
            <div class="review-button">
                <input class=" btn   btn-warning" type="submit" onclick="return( check_reviewform());" name="submit_review" title="<?php echo JText::_ ('COM_VIRTUEMART_REVIEW_SUBMIT')  ?>" value="<?php echo JText::_ ('COM_VIRTUEMART_REVIEW_SUBMIT')  ?>"/>
            </div>
            <?php
            } else {
